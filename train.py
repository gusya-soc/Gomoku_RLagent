...
# game = TrainGame("FIVE CHESS " + GAME_VERSION, GAME_PLAY_MODE, AI_RUN_FIRST)
# tf_agent = game.agent
# while True:
# 	game.play()
...
# random_policy = random_tf_policy.RandomTFPolicy(game.env.time_step_spec(),
#                                                 game.env.action_spec())
